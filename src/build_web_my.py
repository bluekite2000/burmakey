...
/* ---------- More pane ---------- */
#pane-test,#pane-fb,#pane-about{overflow-y:auto;-webkit-overflow-scrolling:touch;
...
<nav class="tabs" role="tablist" aria-label="အပိုင်းများ · sections">
 ...
 <button role="tab" id="tab-test"  aria-selected="false" aria-controls="pane-test"
  aria-label="လေ့ကျင့်ခန်း · Test" onclick="showTab('test')">လေ့ကျင့်</button>
 <button role="tab" id="tab-fb"    aria-selected="false" aria-controls="pane-fb"
  aria-label="သင့်အမြင် · Feedback" onclick="showTab('fb')">အမြင်</button>
...
<section class="pane" id="pane-fb" role="tabpanel" aria-labelledby="tab-fb" hidden>
<div class="fb">
...
<p class="sub">Burglish ရိုက်နေကျအတိုင်း ရိုက်ပါ — အသံထွက်အတိုင်း — မှန်တဲ့စာလုံးကို နှိပ်ပါ · type Burglish the way it sounds, tap the right word, get real Burmese</p>
...
function exFinish(){
  ...
  d.innerHTML="<b>ကျေးဇူးတင်ပါတယ် · thank you!</b><br>"+
    ...
    "<span style='color:var(--dim)'>Now open the <b>အမြင် · Feedback</b> tab and press send. "+

...
function askSharingThenTest(){
  ...
  const after=()=>setTimeout(testStart,900);
  say("<b>မျှဝေမှု · sharing</b><br>"+
      ...
      "May I also send what you type, to improve the dictionary?<br><br>"+
      "<span class='dim'>ပြီးရင် အလုပ်ငယ် ၁၈ ခု · then 18 short tasks. "+
      "Stop any time.</span>",[
